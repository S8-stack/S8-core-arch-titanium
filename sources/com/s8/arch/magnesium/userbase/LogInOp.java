...
public class LogInOp extends UserMgOperation<BeBranch> {
	...
	public LogInOp(long timeStamp, MgUserbase handler, String username, String password, BooleanMgCallback onProcessed, ExceptionMgCallback onFailed) {
		super(timeStamp);

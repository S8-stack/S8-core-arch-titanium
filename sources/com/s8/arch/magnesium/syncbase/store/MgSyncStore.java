...
public class MgSyncStore {
	...
	public MgSyncStore(MgSyncStoreHandler handler, NdCodebase codebase, String rootPathname) {
		super();
	...
	*/
	...
	public static class Serialized {
		...
		public MgSyncStore deserialize(MgSyncStoreHandler handler, NdCodebase codebase) {
			return new MgSyncStore(handler, codebase, rootPathname);
		}
	}

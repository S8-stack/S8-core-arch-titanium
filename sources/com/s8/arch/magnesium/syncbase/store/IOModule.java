...
public class IOModule implements MgIOModule<MgSyncStore> {

	private static JOOS_Lexicon lexicon;
	
	
	public static JOOS_Lexicon JOOS_getLexicon() throws JOOS_CompilingException {
		if(lexicon == null) { lexicon = JOOS_Lexicon.from(MgSyncStore.Serialized.class, MgBranchHandler.Serialized.class); }
		return lexicon;
	}
	...
	public IOModule(MgSyncStoreHandler handler) {
		super();
	...
	@Override
	public MgSyncStore load() throws IOException, JOOS_ParsingException, JOOS_CompilingException {
		...
		MgSyncStore.Serialized repo = (MgSyncStore.Serialized) lexicon.parse(reader, true);
	...
	@Override
	public void save(MgSyncStore repo) throws Exception {

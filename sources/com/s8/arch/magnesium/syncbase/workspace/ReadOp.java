 ...
 *
 */
class ReadOp extends UserMgOperation<NdBranch> {
	 ...
	 * @param onFailed
	 */
	public ReadOp(long timestamp,
			MgWorkspaceHandler handler,  NdObject[] objects, ObjectsMgCallback onSucceed, ExceptionMgCallback onFailed) {
		super(timestamp);

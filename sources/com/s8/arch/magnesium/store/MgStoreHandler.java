 ...
 *
 */
public class MgStoreHandler extends MgHandler<MgStore> {
	...
	public MgStoreHandler(SiliconEngine ng, NdCodebase codebase, Path storeInfoPathname) {
		super(ng);
	...
	@Override
	public MgIOModule<MgStore> getIOModule() {
		return ioModule;
	}

	@Override
	public void getSubUnmountables(List<MgUnmountable> unmountables) {
		MgStore store = getResource();
